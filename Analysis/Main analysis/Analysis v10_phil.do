...
global HH		0		// Set to 1 if want to run, 0 otherwise
...
foreach v in 2 3 {
	...
	recode EDF3D_* (-1000/0 = .) 
	g 		EDF3C_2_continuous = EDF3C_2 if EDF3C_2==0
	replace EDF3C_2_continuous = EDF3D_3 if   EDF3C_2==1 & EDF3D_3!=.
	replace EDF3C_2_continuous = EDF3D_3 + EDF3D_4  if   EDF3C_2==1 & EDF3D_4!=.
	replace EDF3C_2_continuous = EDF3E_2 if   EDF3C_2==-1 & EDF3E_2!=.
		
	g 		EDF3C_3_continuous = EDF3C_3 if EDF3C_3==0
	replace EDF3C_3_continuous = EDF3D_5 if   EDF3C_3==1 & EDF3D_5!=.
	replace EDF3C_3_continuous = EDF3D_5 + EDF3D_6  if   EDF3C_3==1 & EDF3D_6!=.
	replace EDF3C_3_continuous = EDF3E_3 if   EDF3C_3==-1 & EDF3E_3!=.
